...
export const TwitterIcon = (props) => (
    <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 7.184L18.901 1.153zm-1.61 19.993h2.52L6.183 2.92h-2.73l13.758 18.226z"/>
    </svg>
);

export const LinktreeIcon = (props) => (
    <svg {...props} role="img" viewBox="0 0 80 97.7" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
